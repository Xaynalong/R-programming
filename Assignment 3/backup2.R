...
plot(fit, main = "Cutted Documents Dendogram ", xlab = "", sub = "",hang = -1) 
hfit= cutree(fit, k = 9) #cutting dendogram 
rect.hclust(fit, k = 9, border = "blue") #cutting dendogram
...
cfb3 = cluster_fast_greedy(g)
# Plot the graph with explicit node colors
plot(cfb3, asp = 0, g, layout = layout.circle, edge.width = E(g)$weight, 
